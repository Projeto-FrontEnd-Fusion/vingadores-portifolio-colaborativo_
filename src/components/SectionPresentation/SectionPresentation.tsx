...
const SectionPresentation = () => {
    return (
        <section className="text-white flex flex-col gap-[2.813rem] px-[0.313rem] py-[2.813rem] 
                            md:flex-row md:px-[2.844rem] md:pt-24 md:pb-[11.125rem] md:gap-24"
        >
            <div className="flex flex-col gap-8 items-center w-[22.875rem] h-[17.938rem] px-[0.656rem]
                            md:w-[34.188rem] md:h-[22.125rem] md:px-0"
            >
            ...
            <div className="flex flex-col gap-4 w-[21rem] h-[27.25rem] px-[1.594rem]
                            md:px-0 md:w-[34.125rem] md:h-[18.5rem]"
            >
